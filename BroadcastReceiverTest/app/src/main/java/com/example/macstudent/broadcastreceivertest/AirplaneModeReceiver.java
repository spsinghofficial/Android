...
public class AirplaneModeReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        // listen for mesages from the custom publisher (MainActivity.java)
        if (intent.getAction() == "com.example.macstudent.broadcastreceivertest.MYCUSTOMINTENT") {
            // 2. what do you want to do when your receive that message?
            Toast.makeText(context, "I got the message!!", Toast.LENGTH_LONG).show();
        }
